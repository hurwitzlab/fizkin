...
matrix_file = "~/work/fizkin-paper/sna/matrix_raw.txt"
raw = read.table(matrix_file, header = TRUE)
dat = as.dist(1 - dat/nreads)
fit = hclust(dat, method = "ward.D2") 
out.file = file.path(out_dir, "distance.png")
ggsave(out.file, 
       width=5, 
       height=5,
